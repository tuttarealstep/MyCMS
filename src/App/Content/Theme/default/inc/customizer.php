<?php
    ...
    $this->container['theme']->add_tag("backgroundColor", $this->getThemeSetting("backgroundColor"));
    $this->container['theme']->add_tag("navbarBackgroundColor", $this->getThemeSetting("navbarBackgroundColor"));
    $this->container['theme']->add_tag("navbarLogoColor", $this->getThemeSetting("navbarLogoColor"));
    $this->container['theme']->add_tag("navbarMenuTextColor", $this->getThemeSetting("navbarMenuTextColor"));
    $this->container['theme']->add_tag("bodyColor", $this->getThemeSetting("bodyColor"));

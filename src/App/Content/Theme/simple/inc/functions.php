...
$this->container['router']->map('GET', '/error', 'error');
...
$this->container['theme']->addStyleScript('css', '{@siteURL@}/src/App/Content/Theme/{@siteTEMPLATE@}/assets/css/fontawesome-all.min.css');
...
$this->container['theme']->addStyleScript('script', '{@siteURL@}/src/App/Content/Theme/{@siteTEMPLATE@}/assets/js/bootstrap.bundle.min.js');

    ...
    class MyCMSLanguage
    {
        ...
        function __construct($container)
        {
            ...
            if (!defined("MY_LANGUAGE")) {
                $site_language = $settings->get_settings_value('site_language');
            ...
            if (!defined("MY_LANGUAGE_THEME")) {
                $site_language = $settings->get_settings_value('site_template_language');
                if (!empty($site_language)) {
        ...
        {
            $theme_path = $this->theme->get_theme_path();

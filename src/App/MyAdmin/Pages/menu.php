...
addStyleScriptAdmin('css', '{@MY_ADMIN_TEMPLATE_PATH@}/Assets/css/icon-picker.min.css');
addStyleScriptAdmin('script', '{@MY_ADMIN_TEMPLATE_PATH@}/Assets/js/iconPicker.min.js');
addStyleScriptAdmin('script', '{@MY_ADMIN_TEMPLATE_PATH@}/Assets/js/jquery-ui.min.js');
                        ...
                        <div class="panel-body-padding">
                            ...
                            <select name="url" class="form-control b_form-control">
                                ...
                                foreach ($page as $pagerow) {
                                    $i++;
                                    ?>
                                    <option value="<?php echo $pagerow['pageTITLE']; ?>"><?php echo removeSpace($pagerow['pageTITLE']); ?></option>
                                    <?php
                                }
                                ?>
                            </select>

...
if (isset($_POST['posts_new_create'])) {
    if (!empty($_POST['posts_title'])) {
        if (!empty($_POST['posts_content'])) {
            ...
            $my_db->query("INSERT INTO my_blog (postTITLE,postCONT,postDATE,postAUTHOR,postCATEGORY,postPOSTED,postPERMALINK,postSTATUS) VALUES ('$posts_title', '$posts_content', '$date', '$author', '$category', '1', '$permalink', '$postSTATUS')");
...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            ...
            <h1 class="h1PagesTitle"><?php ea('page_posts_new_header'); ?></h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
                ...
                <div class="form-group">
                    <div class="panel b_panel">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne"
                                   class="accordion-toggle"><?php ea('page_posts_new_publish'); ?></a>
                            </h4>
                        </div>
                        ...
                        <button type="submit" name="posts_new_create" id="posts_new_create"
                                class="btn btn-primary b_btn btn-block"><?php ea('page_posts_new_publish_button'); ?></button>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"
                                   class="accordion-toggle"><?php ea('page_posts_new_category'); ?></a>
                            </h4>
                        </div>
                        <div id="collapseTwo" class="panel-collapse collapse in" style="">
                            <div class="panel-body b_panel-body">
                                <div class="panel-body-padding">
                                    ...
                                    <br>
                                    <a href="#category-add"
                                       id="category-add-button"><?php ea('page_posts_new_category_button'); ?></a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-6 col-xs-6">
                                                <a class="btn btn-primary b_btn btn-block" name="addNewCategoryName"
                                                   id="addNewCategoryName"><?php ea('page_posts_category_new_button'); ?></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
